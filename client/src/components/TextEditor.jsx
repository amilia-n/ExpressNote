  ...
  return (
    <div className="editor-container">
      <div className={`editor-header ${isCollapsed ? 'collapsed' : ''}`}>
        ...
        <button className="font-size-down">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <button className="editor-delete" onClick={onClose}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        {isCollapsed ? (
          <button className="toolbar-expand" onClick={handleCollapseToggle}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <>
            <button className="toolbar-close" onClick={handleCollapseToggle}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
